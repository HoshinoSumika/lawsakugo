...
import { convert } from './service/convert.js?v=20251024';
import { tagParen, tagConj } from './service/tag.js?v=20251024';

function getLawData(id) {
    let result = fetchServer(id);
    if (!result) {
        result = fetchInternet(id);
    }
    return result;
}
